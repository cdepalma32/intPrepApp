...
{ word: 'bigint', scrambled: 'gtnbii', solution: 'bigint', topic: topics[0]._id },
...
{ word: 'spidermonkey', scrambled: 'romspynieedk', solution: 'spidermonkey', topic: topics[0]._id },
...
{ word: 'lifecycle', scrambled: 'iceelclfy', solution: 'lifecycle', topic: topics[0]._id },
...
{ word: 'keyof', scrambled: 'kfeyo', solution: 'keyof', topic: topics[0]._id },
...
{ word: 'errorboundary', scrambled: 'barrrdyonruoe', solution: 'errorboundary', topic: topics[1]._id },
...
{ word: 'customhook', scrambled: 'hokosmcuto', solution: 'customhook', topic: topics[1]._id },
...
{ word: 'lifecycle', scrambled: 'cfliylcee', solution: 'lifecycle', topic: topics[1]._id },
...
{ word: 'purecomponent', scrambled: 'pnuoeotcprmne', solution: 'purecomponent', topic: topics[1]._id },
{ word: 'classcomponent', scrambled: 'sctpmnoaonlsec', solution: 'classcomponent', topic: topics[1]._id },
{ word: 'functionalcomponent', scrambled: 'tctomflcennpiuannoo', solution: 'functionalcomponent', topic: topics[1]._id },
...
{ word: 'propsdrilling', scrambled: 'gipilpdosnrlr', solution: 'propsdrilling', topic: topics[1]._id },
{ word: 'liftingstate', scrambled: 'nfglstititea', solution: 'liftingstate', topic: topics[1]._id },
...
{ word: 'renderprops', scrambled: 'prerropdsne', solution: 'renderprops', topic: topics[1]._id },
{ word: 'propTypes', scrambled: 'psTprepyo', solution: 'propTypes', topic: topics[1]._id },
{ word: 'defaultprops', scrambled: 'oratdsplfpue', solution: 'defaultprops', topic: topics[1]._id },
...
{ word: 'strictmode', scrambled: 'ttocdserim', solution: 'strictmode', topic: topics[1]._id },
...
{ word: 'nestedroutes', scrambled: 'eesotrtnduse', solution: 'nestedroutes', topic: topics[1]._id },
...
{ word: 'styledcomponents', scrambled: 'mldcneosetynstpo', solution: 'styledcomponents', topic: topics[1]._id },
...
{ word: 'classnames', scrambled: 'enmssaclsa', solution: 'classnames', topic: topics[1]._id },
{ word: 'cssmodules', scrambled: 'sueosmlscd', solution: 'cssmodules', topic: topics[1]._id },
{ word: 'bemt', scrambled: 'tbem', solution: 'bemt', topic: topics[1]._id },
{ word: 'theming', scrambled: 'igtnhme', solution: 'theming', topic: topics[1]._id },
{ word: 'darkmode', scrambled: 'kdadermo', solution: 'darkmode', topic: topics[1]._id },
...
{ word: 'concurrentmode', scrambled: 'onmetercrndouc', solution: 'concurrentmode', topic: topics[1]._id },
{ word: 'starttransition', scrambled: 'rrsttionsaintta', solution: 'starttransition', topic: topics[1]._id },
{ word: 'suspenseboundary', scrambled: 'peseuousnadybrns', solution: 'suspenseboundary', topic: topics[1]._id },
{ word: 'codeSplitting', scrambled: 'teoitndigclSp', solution: 'codeSplitting', topic: topics[1]._id },
{ word: 'lazyloading', scrambled: 'aioaydgnzll', solution: 'lazyloading', topic: topics[1]._id },
{ word: 'treeShaking', scrambled: 'rnekatShige', solution: 'treeShaking', topic: topics[1]._id },
{ word: 'devtools', scrambled: 'delstvoo', solution: 'devtools', topic: topics[1]._id },
{ word: 'hotreload', scrambled: 'dohtraloe', solution: 'hotreload', topic: topics[1]._id },
{ word: 'fastrefresh', scrambled: 'sefarfshtre', solution: 'fastrefresh', topic: topics[1]._id },
...
{ word: 'testinglibrary', scrambled: 'sitabertngriyl', solution: 'testinglibrary', topic: topics[1]._id },
...
{ word: 'asyncawait', scrambled: 'wsiaaatncy', solution: 'asyncawait', topic: topics[1]._id },
{ word: 'errorhandling', scrambled: 'giaorhrrnelnd', solution: 'errorhandling', topic: topics[1]._id },
...
{ word: 'reacthookform', scrambled: 'haomrcfotkroe', solution: 'reacthookform', topic: topics[1]._id },
...
{ word: 'syntheticevent', scrambled: 'cehnseytvtinet', solution: 'syntheticevent', topic: topics[1]._id },
...
{ word: 'arrowfunction', scrambled: 'fwnnirtuaorco', solution: 'arrowfunction', topic: topics[1]._id },
{ word: 'fatarrow', scrambled: 'tfawoarr', solution: 'fatarrow', topic: topics[1]._id },
{ word: 'callbackref', scrambled: 'elrafclbkac', solution: 'callbackref', topic: topics[1]._id },
{ word: 'domref', scrambled: 'emdorf', solution: 'domref', topic: topics[1]._id },
{ word: 'focus', scrambled: 'fsuoc', solution: 'focus', topic: topics[1]._id },
{ word: 'blur', scrambled: 'lrbu', solution: 'blur', topic: topics[1]._id },
{ word: 'customcomponent', scrambled: 'cncooeosptnmtmu', solution: 'customcomponent', topic: topics[1]._id },
...
{ word: 'cleanCode', scrambled: 'oledcneaC', solution: 'cleanCode', topic: topics[1]._id },
...
{ word: 'compositionapi', scrambled: 'ptoaiciposomin', solution: 'compositionapi', topic: topics[1]._id },
...
{ word: 'callstack', scrambled: 'tlasaclck', solution: 'callstack', topic: topics[1]._id },
{ word: 'watch', scrambled: 'hcwat', solution: 'watch', topic: topics[1]._id },
{ word: 'redux', scrambled: 'xrude', solution: 'redux', topic: topics[1]._id },
{ word: 'contextapi', scrambled: 'acntxetipo', solution: 'contextapi', topic: topics[1]._id },
...
{ word: 'eventloop', scrambled: 'oetlevonp', solution: 'eventloop', topic: topics[2]._id },
{ word: 'nonblocking', scrambled: 'ncnnkiglboo', solution: 'nonblocking', topic: topics[2]._id },
...
{ word: 'childprocess', scrambled: 'risscoelcpdh', solution: 'childprocess', topic: topics[2]._id },
...
{ word: 'dirname', scrambled: 'rnemadi', solution: 'dirname', topic: topics[2]._id },
{ word: 'filename', scrambled: 'eanmiefl', solution: 'filename', topic: topics[2]._id },
...
{ word: 'devdependency', scrambled: 'yvpeedeecdndn', solution: 'devdependency', topic: topics[2]._id },
...
{ word: 'crossenv', scrambled: 'oesscvnr', solution: 'crossenv', topic: topics[2]._id },
...
{ word: 'bodyparser', scrambled: 'yearpodbsr', solution: 'bodyparser', topic: topics[2]._id },
...
{ word: 'cookieparser', scrambled: 'coeiroskerpa', solution: 'cookieparser', topic: topics[2]._id },
...
{ word: 'trycatch', scrambled: 'ccyrthat', solution: 'trycatch', topic: topics[2]._id },
...
{ word: 'addon', scrambled: 'dnaod', solution: 'addon', topic: topics[2]._id },
...
{ word: 'rateLimiter', scrambled: 'iertiaLtemr', solution: 'rateLimiter', topic: topics[2]._id },
...
{ word: 'httpserver', scrambled: 'stvheerptr', solution: 'httpserver', topic: topics[2]._id },
{ word: 'httpsserver', scrambled: 'seehtprtsvr', solution: 'httpsserver', topic: topics[2]._id },
...
{ word: 'realtime', scrambled: 'ereamilt', solution: 'realtime', topic: topics[2]._id },
{ word: 'eventemitter', scrambled: 'rmtenteevtie', solution: 'eventemitter', topic: topics[2]._id },
...
{ word: 'threadpool', scrambled: 'lhrootpdae', solution: 'threadpool', topic: topics[2]._id },
...
{ word: 'rpc', scrambled: 'rcp', solution: 'rpc', topic: topics[2]._id },
...
{ word: 'changeStream', scrambled: 'rtSmcegnaeha', solution: 'changeStream', topic: topics[3]._id },
...
{ word: 'free', scrambled: 'rfee', solution: 'free', topic: topics[3]._id },
...
{ word: 'kerberos', scrambled: 'ekeobsrr', solution: 'kerberos', topic: topics[3]._id },
...
{ word: 'ipwhitelist', scrambled: 'ihitiswelpt', solution: 'ipwhitelist', topic: topics[3]._id },
{ word: 'indexing', scrambled: 'ixngdein', solution: 'indexing', topic: topics[3]._id },
{ word: 'queryplanner', scrambled: 'renrequlpnay', solution: 'queryplanner', topic: topics[3]._id },
{ word: 'executionplan', scrambled: 'cpuneitlnoeax', solution: 'executionplan', topic: topics[3]._id },
...
{ word: 'strong', scrambled: 'nsgrto', solution: 'strong', topic: topics[3]._id },
...
{ word: 'atlassearch', scrambled: 'ahlraecssat', solution: 'atlassearch', topic: topics[3]._id },
...
{ word: 'cookieparser', scrambled: 'esircokorape', solution: 'cookieparser', topic: topics[4]._id },
{ word: 'bodyparser', scrambled: 'esroabdrpy', solution: 'bodyparser', topic: topics[4]._id },
{ word: 'urlencoded', scrambled: 'rloeucdend', solution: 'urlencoded', topic: topics[4]._id },
{ word: 'jsonparser', scrambled: 'ssnajerpro', solution: 'jsonparser', topic: topics[4]._id },
...
{ word: 'expressvalidator', scrambled: 'ilasxdesprretavo', solution: 'expressvalidator', topic: topics[4]._id },
...
{ word: 'rateLimit', scrambled: 'aiiettmrL', solution: 'rateLimit', topic: topics[4]._id },
...
{ word: 'reverseproxy', scrambled: 'peeorrrevsxy', solution: 'reverseproxy', topic: topics[4]._id },
{ word: 'loadbalancer', scrambled: 'adalacnobrle', solution: 'loadbalancer', topic: topics[4]._id },
...
{ word: 'childprocess', scrambled: 'lcsohpesrdci', solution: 'childprocess', topic: topics[4]._id },
